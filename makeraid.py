...
def track_warning(null, n_tracks) -> str:
    ...
    (z=+4.55)». Це результат 2026-07-17 — найкращої ночі в наборі. Перевірено на
    всіх 31: медіана z = 0.00, поріг z>2 перетинають лише 4 ночі, на багатьох
    треків менше, ніж дає перемішування. Тобто типової ночі сторінка стверджувала
    значущість, якої в її власних даних не було.
    """
