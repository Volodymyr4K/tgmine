...
NAMES = {
    ...
    "Адигея": ("Адигея", "Adygea"),
    "Чувашія": ("Чувашія", "Chuvashia"),
    "Марій Ел": ("Марій Ел", "Mari El"),
    "Кіровська": ("Кіровська обл.", "Kirov Oblast"),
    "Вологодська": ("Вологодська обл.", "Vologda Oblast"),
    "Калмикія": ("Калмикія", "Kalmykia"),
    "Псковська": ("Псковська обл.", "Pskov Oblast"),
    "Карелія": ("Карелія", "Karelia"),
    "Північна Осетія": ("Північна Осетія", "North Ossetia"),
    "Інгушетія": ("Інгушетія", "Ingushetia"),
    "Чечня": ("Чечня", "Chechnya"),
    "Кабардино-Балкарія": ("Кабардино-Балкарія", "Kabardino-Balkaria"),
    "Карачаєво-Черкесія": ("Карачаєво-Черкесія", "Karachay-Cherkessia"),
    "Архангельська": ("Архангельська обл.", "Arkhangelsk Oblast"),
    "Мурманська": ("Мурманська обл.", "Murmansk Oblast"),
    "Калінінградська": ("Калінінградська обл.", "Kaliningrad Oblast"),
    "Комі": ("Комі", "Komi"),
