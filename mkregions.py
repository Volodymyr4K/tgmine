...
MATCH = {
    ...
    "Татарстан":        ["Татарстан"],
    "Свердловська":     ["Свердловская область"],
    "Пермський":        ["Пермский край"],
    "Тюменська":        ["Тюменская область"],
    "Челябінська":      ["Челябинская область"],
    "Курганська":       ["Курганская область"],
    "Омська":           ["Омская область"],
