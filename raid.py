...
def null_test(dets, observed, shuffles=NULL_SHUFFLES):
    ...
    найкращої ночі в наборі. Медіана z по 31 ночі = 0.00, поріг z>2 перетинають
    4 ночі. Тобто типової ночі треки від випадковості не відрізняються, а
    сторінка стверджувала протилежне.
    """
    if len(dets) < 10:
        return None
