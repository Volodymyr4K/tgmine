...
class TestPlannedLaunchIsNotALaunch(unittest.TestCase):
    ...
    def test_intent_flag_covers_the_whole_post(self):
        """Прапорець наміру — на весь пост, свідомо.

        Єдиний змішаний пост у сховищі — огляд по регіонах із місцем на
        Брянщині й пусками з Миколаївщини. «По кожній згадці» ставило б пуск
        на Брянщині; фіксація там правильна.
        """
        text = ("На данный момент БПЛА противника: / Брянская область крайне много "
                "в направлении Смоленской и Калужской области. / ЛНР фиксации в "
                "направлении Белгородской / Николаевская и Одесская область "
                "периодические пуски БПЛА в направлении Крыма / Подготовку пусков "
                "Штормов пока не фиксируем. Режим Внимание")
