...
def is_excluded(obj: dict, borders: Borders) -> str | None:
    ...
    # Інші країни — теж геть. Плитки прямокутні, і в перелік цілей РФ
    # потрапили 96 обʼєктів Білорусі й 29 Казахстану (аеродром Зябровка,
    # «Ваенкамат» як флот, казахські нафтобази); з 23.09.2026 пошук
    # редактора бачить ярус 1-2 аж до 82° сх., і вони вилізли туди.
    if a3 not in ("RUS", "UKR"):
        return f"інша країна ({a3})"
